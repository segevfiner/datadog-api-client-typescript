...
export class LogsIndexUpdateRequest {
   ...
   * and then stored in Flex Tier until number of days specified in `num_flex_logs_retention_days` is reached.
   ...
   * The available values depend on the retention plans specified in your organization's contract/subscriptions.
   *
   * **Note**: Changing this value affects all logs already in this index. It may also affect billing.
   */
